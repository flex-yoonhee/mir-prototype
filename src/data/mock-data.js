...
export const voiceDetail = {
  ...
  note: '앞으로의 미래를 위해 서로에게 좋은 방향을 가감없이 논의하고, 결정하는 자리가 된다면 좋겠습니다.',
  aiSummary: {
    overview: '기존의 \'플렉스 데스크\'를 \'플렉스 AI\' 데스크톱 앱으로 통합하는 과정에서 필요한 기능적 위계 정리와 시스템 개선 사항을 점검합니다. 또한 CEO 앱의 개발 현황, 개인정보 보호 문제, 멀티 법인 대응 및 윈도우 환경 최적화 등 향후 주요 마일스톤(5월 말~7월 초)을 달성하기 위한 세부 계획을 논의하였습니다.',
    participants: '김종현, 노영은, 박민수, 박종상, 소기현, 이명현, 이윤희, 이진혁, 이택규, 정선우, 최동근, 최원용',
    keyTopics: [
      {
        title: '시스템 기능 개선 및 관측성 강화',
        items: [
          '할 일 제한 및 대시보드: 기존 시험실 대시보드에 작업 제한 기능을 적용하는 기초 작업을 진행 중이며, 비동기 처리 기반의 소스 코드를 활용하고 있습니다.',
          '개인 식별 정보(PIA) 관리: 로그에 개인 정보가 날것으로 노출되지 않도록 개선 방안을 고민 중입니다.',
        ],
      },
      {
        title: 'CEO 앱 개발 및 데이터 추출',
        items: [
          '디자인 및 스펙: 지난주 공유된 구현 스펙을 바탕으로 이번 주에는 앱 컨셉과 디자인 싱크를 진행할 예정입니다.',
          '시그널 추출 테스트: 목데이터(Mock Data)를 생성하고 POC에서 사용된 프롬프트를 활용하여, 플렉스 외의 기업 환경에서 어느 정도의 시그널이 추출되는지 테스트를 계획하고 있습니다.',
        ],
      },
    ],
    decisions: [
      '허브 통합 방향: \'플렉스 데스크\'는 \'플렉스 AI\' 데스크톱 앱으로 통합되며, 이에 따른 위계 정리를 진행합니다.',
      'TTS 제외: 이번 개발 범위(Scope)에서 TTS 기능은 제외하기로 합의하였습니다.',
    ],
    openItems: [
      '에이전트 루프 개선 계획: 반응성 개선을 위한 구체적인 구현 레벨의 계획과 타임라인 확정이 필요합니다.',
      '다법인 UX 정책: 다법인 사용자의 진입 프로세스(주법인 자동 진입 vs 법인 선택)에 대한 최종 정책 결정이 필요합니다.',
    ],
  },
};
...
export const mirrorData = {
  ...
  actions: [
    '김서준 면담 후속 조치 — 보상 조율 결과를 CHRO에게 공유',
    '위임 가능한 할일 2건 식별 — 이번 주 내 위임 실행',
    '내일 이사회 법인 안건 사전 정리 30분 확보',
  ],
  conversations: [
    { title: '김서준 후속 대응 방향을 제안해줘', date: '2026. 4. 27 (목) 12:55', hasUnread: true },
    ...
    sections: [
      {
        ...
        decisions: [
          '진입점에서는 어떤 토픽/시그널/피드백인지 참조(ID)만 전달. 에이전트가 필요에 따라 데이터 조회',
          '진입점에 따라 동작이 달라지거나 제한되지 않음 — 자유롭게 다른 주제 전환 가능',
    ...
    sections: [
      {
        ...
        decisions: [
          '종합 의견 + 잘하고 있는 것 + 주의해야 할 것 + 액션 아이템 제안 구조',
